...
FEDERATION_V1_PREFIX = f"{FEDERATION_PREFIX}/v1"
FEDERATION_V2_PREFIX = f"{FEDERATION_PREFIX}/v2"
FEDERATION_UNSTABLE_PREFIX = f"{FEDERATION_PREFIX}/unstable"
